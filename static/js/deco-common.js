...
function search_click(){
    ...
    if(type == "course"){
        request_url = "{% url 'course: course_list' %}?keywords="+keywords
    }else if(type == "teacher"){
        request_url = "{% url 'teacher: teacher_list' %}?keywords="+keywords
    }else if(type == "org"){
        request_url = "{% url 'org: org_list' %}?keywords="+keywords
    }
